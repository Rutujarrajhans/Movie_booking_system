...
user_email = Entry(root,text="2018.rutuja.rajhans@ves.ac.in", bd =8)
user_email.insert(END,"2018.rutuja.rajhans@ves.ac.in")
...
#subj.insert(END,"ticket been booked")
subj.pack( )
...
body.insert(END,"YOU JUST VIEWED INFO ABT U R TICKET BEEN BOOKED.your accnt no.,price,seat/s booked,in last page")
...
password= Entry(root, text="ruhi30@#",show='*', bd =8)
password.insert(END,'ruhi30@#')
